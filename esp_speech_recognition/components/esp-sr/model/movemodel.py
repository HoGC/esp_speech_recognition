...
if os.path.exists(target_model):
    ...
    os.system("rm -rf {}".format(target_model))
    os.system("mkdir {}".format(target_model))
if wakenet_model != 'null':
    os.system("cp -r {} {}".format(model_path + '/wakenet_model/' + wakenet_model, target_model+'/'+wakenet_model))
if multinet_model != 'null':
    os.system("cp -r {} {}".format(model_path + '/multinet_model/' + multinet_model, target_model+'/'+multinet_model))
